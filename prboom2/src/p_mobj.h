...
#define MF3_TUNNEL            0x08000000ull // if ripper projectile, only does damage to a single thing once
#define MF3_GENERIC1          0x01000000ull // generic flag 1
#define MF3_GENERIC2          0x02000000ull // generic flag 2
